...
/**
 * This is the model class for table "galery_co_dau".
 *
 * The followings are the available columns in table 'galery_co_dau':
 * @property integer $id
 * @property string $tieu_de
 * @property string $hinh_anh
 * @property string $updated
 */
class GaleryCoDau extends CActiveRecord
{
	/**
