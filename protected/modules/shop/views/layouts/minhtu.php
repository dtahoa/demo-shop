...
<head>
    ...
    <!-- Le styles  -->
    <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/shop/css/bootstrap.css" rel="stylesheet"/>
    <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/shop/css/bootstrap-responsive.css" rel="stylesheet"/>
    <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/shop/css/docs.css" rel="stylesheet"/>

    <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/shop/style.css" rel="stylesheet"/>
    <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/shop/js/google-code-prettify/prettify.css"
          rel="stylesheet"/>
    ...
    <link rel="shortcut icon" href="<?php echo Yii::app()->request->baseUrl; ?>/css/shop/ico/favicon.ico">
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
          href="<?php echo Yii::app()->request->baseUrl; ?>/css/shop/ico/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
          href="<?php echo Yii::app()->request->baseUrl; ?>/css/shop/ico/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72"
          href="<?php echo Yii::app()->request->baseUrl; ?>/css/shop/ico/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed"
          href="<?php echo Yii::app()->request->baseUrl; ?>/css/shop/ico/apple-touch-icon-57-precomposed.png">
</head>
...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
            <a id="logoM" href="index.html"><img src="css/shop/img/logo.png" alt="Bootsshop"/></a>
...
<div id="mainBody" class="container">
    ...
    <div class="row">
        <div id="sidebar" class="span3">
            <ul class="nav nav-list bs-docs-sidenav" style="display: block;">
                ...
                <li>
                    <div class="thumbnail">
                        <img src="css/shop/products/1.jpg" alt="">
                        <div class="caption">
                            <h5>Product name</h5>
                            <p>
                ...
                <li class="last">
                    <div class="thumbnail">
                        <img src="css/shop/products/2.jpg" alt="">
                        <div class="caption">
                            <h5>Product name</h5>
                            <p>
                                Lorem Ipsum is simply dummy text.
    ...
    <div  id="footerSection">
        <div class="row">
            ...
            <div id="socialMedia" class="span3 pull-right">
                <h5>SOCIAL MEDIA </h5>
                <a href="#"><img width="60" src="css/shop/img/facebook.png" title="facebook"/></a>
                <a href="#"><img width="60" src="css/shop/img/twitter.png" title="twitter"/></a>
                <a href="#"><img width="60" src="css/shop/img/rss.png" title="rss"/></a>
                <a href="#"><img width="60" src="css/shop/img/youtube.png" title="youtube"/></a>
            </div>
        </div>
        <hr class="soft">
    ...
    <script src="css/shop/js/jquery.js"></script>
    <script src="css/shop/js/google-code-prettify/prettify.js"></script>
    <script src="css/shop/js/application.js"></script>
    <script src="css/shop/js/bootstrap-transition.js"></script>
    <script src="css/shop/js/bootstrap-modal.js"></script>
    <script src="css/shop/js/bootstrap-scrollspy.js"></script>
    <script src="css/shop/js/bootstrap-alert.js"></script>
    <script src="css/shop/js/bootstrap-dropdown.js"></script>
    <script src="css/shop/js/bootstrap-tab.js"></script>
    <script src="css/shop/js/bootstrap-tooltip.js"></script>
    <script src="css/shop/js/bootstrap-popover.js"></script>
    <script src="css/shop/js/bootstrap-button.js"></script>
    <script src="css/shop/js/bootstrap-collapse.js"></script>
    <script src="css/shop/js/bootstrap-carousel.js"></script>
    <script src="css/shop/js/bootstrap-typeahead.js"></script>
    <script src="css/shop/js/bootstrap-affix.js"></script>
