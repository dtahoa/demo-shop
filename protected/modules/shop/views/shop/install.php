...
<div class="span-11 last">
    ...
    <table>
        <tr>
            ...
            <td> <?php echo Yii::app()->controller->module->categoryTable; ?> </td>
        </tr>
        <tr>
            <td> Table for Products</td>
            <td> <?php echo Yii::app()->controller->module->productsTable; ?> </td>
        </tr>
        <tr>
            <td> Table for the Shopping Carts</td>
            <td> <?php echo Yii::app()->controller->module->shoppingCartTable; ?> </td>
        </tr>
        <tr>
            <td> Table for the Orderings</td>
            <td> <?php echo Yii::app()->controller->module->orderTable; ?> </td>
        </tr>
        <tr>
            <td> Table for the Customers</td>
            <td> <?php echo Yii::app()->controller->module->customerTable; ?> </td>
        </tr>
        <tr>
            <td> Table for the Product Images</td>
            <td> <?php echo Yii::app()->controller->module->imageTable; ?> </td>
        </tr>
    </table>
    ...
    <p> Your Product images will be stored unter
        Approot<?php echo Yii::app()->controller->module->productImagesFolder; ?> </p>
</div>
