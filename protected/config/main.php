    ...
    'components' => array(
        ...
        'urlManager' => array(
            ...
            'rules' => array(
                ...
                'lien-he-voi-maicuoi' => array('shop/shopInformation/lienhe/id/1', 'urlSuffix' => '.html'),
                'video/video-wedding' => array('shop/videoWedding/index', 'urlSuffix' => '.html'),
                'video/video-phong-su-cuoi' => array('shop/videoPhongSuCuoi/index', 'urlSuffix' => '.html'),
                'video/video-tvc' => array('shop/videoTVC/index', 'urlSuffix' => '.html'),
                'chup-anh-cuoi' => array('shop/thongTinChupAnhCuoi/index', 'urlSuffix' => '.html'),
                'chup-anh-cho-be' => array('shop/dichVuChupAnhChoBe/index', 'urlSuffix' => '.html'),
                'vay-cuoi-cao-cap' => array('shop/dichVuVayCuoi/index', 'urlSuffix' => '.html'),
                'goc-bao-chi' => array('shop/gocBaoChi/index', 'urlSuffix' => '.html'),
                'tin-tuc' => array('shop/tintuc/index', 'urlSuffix' => '.html'),
                'gallery-link/co-dau-xinh-dep-cua-maicuoi' => array('shop/galeryCoDau/index', 'urlSuffix' => '.html'),
                'gallery-link/vay-cuoi-dep' => array('shop/galeryVayCuoi/index', 'urlSuffix' => '.html'),
            ),
        ),
        'yexcel' => array(
        ...
        'widgetFactory' => array(
            'widgets' => array(
                ...
                'CListView' => array(
                    ...
                    'pagerCssClass' => 'dataTables_paginate paging_bootstrap paging_newline_center',
                    'itemsCssClass' => 'table table-striped table-hover',
                    'cssFile' => false,
                    'summaryCssClass' => 'dataTables_info',
                    'summaryText' => 'Showing {start} to {end} of {count} entries',
